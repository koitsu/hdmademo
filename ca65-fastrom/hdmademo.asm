...
.proc RESET
    ...
    xce
    jml RESET_FASTROM             ; switch K to fastrom bank ($80-FF)
.endproc

.proc NMI
    jml NMI_FASTROM               ; switch K to fastrom bank ($80-FF)
.endproc
...
.proc RESET_FASTROM
    ...
    lda #$01
    sta $420D       ; access cycle designation (fastrom 3.58MHz)
...
.segment "CARTINFO"
    ...
    .byte $30                     ; $FFD5:      Mode ($30 = LoROM, fastrom 3.58MHz)
